...
ordered according to newest to oldest, but with the largest 
...
and the primary point of contact (primary_poc) for Exxon Mobil 
...
## ==========================================================================
# using SELECT and arithmetic operations
...
# combine with NOT
'''All companies whose names not end with 's'. '''
...
'''Use the web_events table to find all information regarding individuals
 who were contacted via organic or adwords and started their account 
